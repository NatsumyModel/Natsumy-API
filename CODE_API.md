...
```bash
curl -X POST "https://natsumy.onrender.com/api/generate-code" \
...
Natsumy's code generation follows these principles:
...
```javascript
const response = await fetch('https://natsumy.onrender.com/api/generate-code', {
  method: 'POST',
