...
The Chat API allows you to have natural conversations with Natsumy AI assistant.

## Endpoints

### POST /api/chat

Send a message to Natsumy and receive a conversational response with context awareness.
...
|-----------|------|----------|-------------|
| message | string | Yes | The user's message to send to Natsumy |
...
```json
{
  "response": "I'm Natsumy, a friendly and intelligent AI companion created by talented developers who wanted to make AI assistance more personal and friendly. I'm here to help you with various tasks, answer questions, or just have a nice conversation!",
  "usage": {
    "prompt_tokens": 45,
...
|-------|------|-------------|
| response | string | Natsumy's response message |
...
Natsumy uses the following personality traits:
...
```javascript
const response = await fetch('https://natsumy.onrender.com/api/chat', {
  method: 'POST',
